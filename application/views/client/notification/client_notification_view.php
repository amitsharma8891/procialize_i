                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="stat well well-sm attnd ">
                                            <a href="javascript:;" id="passcode_id1" class="<?php echo $notify['event_id'] ?>" onclick="apply_passcode('<?php echo $notify['event_id']?>' ,'<?php echo  $notify['notification_content'] ?>')">
                                                <h4 class="truncate">Your Passcode for the <?php echo $notify['event_name']?> event is <?php echo $notify['notification_content'] ?></h4>
                                            </a>
                                        <small class="stat-label"><?php echo $type_of_user ?>Sent you a message</small>
                                        <small class="stat-label"><?php echo date('d M Y', strtotime($notify['notification_date'])) . ', ' . $notify['event_name'] ?></small>
                                        </div>
                                    </div>
                                </div>
                            <?php
