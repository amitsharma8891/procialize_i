			...
			<div class="col-xs-12">
				<div class="stat">
					...
					<div class="omb_login">
						...
						<h3 class="text-center" style="color:#58595b">No Data</h3>
                        <h4 class="text-center" style="color:#58595b; margin-bottom:10px;" >You haven't saved any Blah-Blah yet.</h4>
                        
                        <div class="row omb_row-sm-offset-3 mb10">
                            <div class="col-xs-12 col-sm-6">	
                                <!--<form class="omb_loginForm" action="" autocomplete="off" method="POST">-->
                                     <p class="text-center" style="color:#58595b; margin-bottom:10px;">Please visit any Blah-Blah and save their profiles.</p>
                                <!--</form>-->
                            </div>
                        </div>
					</div>
