			...
			<div class="col-xs-12">
				<div class="stat">
					...
					<div class="omb_login">
						...
						<h3 class="text-center" style="color:#58595b">404!</h3>
                        <h4 class="text-center" style="color:#58595b; margin-bottom:10px;" >Oops! Something went wrong :(</h4>
                        
                        <div class="row omb_row-sm-offset-3 mb10">
                            <div class="col-xs-12 col-sm-6">	
                                <!--<form class="omb_loginForm" action="" autocomplete="off" method="POST">-->
                                     <p class="text-center" style="color:#58595b; margin-bottom:10px;">The page you are looking for could not be found.</p>
    
                                     <a href="<?php echo SITE_URL?>events"><button class="btn btn-success btn-block" >Back</button></a>
                                <!--</form>-->
                            </div>
                        </div>
					</div>
