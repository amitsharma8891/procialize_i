                                ...
                                <tr>
                                    ...
                                    if ($this->session->userdata('is_superadmin') == 1 || $type == 'O') {
                                        ...
                                        <td class="tdalign">
                                            ...
                                            <a class="btn btn-default btn-sm" href="<?php echo base_url() ?>manage/login/adminLogin/E/<?php echo ($exhibitor["user_id"]) ?>" onClick="return confirm('Please confirm if you would like to login on behalf of this user?')">Login</a>
                                        </td>
                                    <?php } ?>
                                </tr>
                            <?php } ?>
