        ...
        <form onsubmit="return false" id="setting_form">
            ...
            <div class="form-group" style="display: none;">
                <div class="col-sm-6">
                    ...
                    <input type="text" name="welcome_message" placeholder="Welcome Message " class="form-control" value="<?php echo "Welcome to ".getSetting()->app_name;//$setting['app_wecome_message'] ?>">
                    <span class="error" id="welcome_message_err"></span>
                </div>
            </div>
            <div class="form-group">
                <h3 class="col-sm-12">Upload App Logo</h3>
                <span class="help-block col-sm-12">App Logo must be PNG file and should be less than 3 MB. </span> 
            </div>
            <div class="form-group">
                <div class="col-sm-2">
            ...
            <div class="form-group">
                ...
                <span class="help-block col-sm-12">App background Image must be JPG/JPEG/PNG and recommended to be smaller than 1 MB.</span> 
            </div>
            <div class="form-group">
                <div class="col-sm-2">
                  <!--<div class="fileinput fileinput-new" data-provides="fileinput"> <a href="#" title="remove" class="closebtn fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i></a>
            ...
            <div class="form-group">
                ...
                <span class="help-block col-sm-12">You can upload multiple Slider images, arrange their order. The images must be JPG/JPEG/PNG and recommended to be smaller than 1 MB.</span> 
            </div>
            <div class="form-group">
                <div class="col-sm-6">
                  <!--<div class="fileinput fileinput-new" data-provides="fileinput"> <a href="#" title="remove" class="closebtn fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i></a>
