...
<div class="contentpanel"><!-- Content Panel -->
    <div class="row mb20"><!-- Exhibitor Row -->
        ...
        <div class="col-sm-12 col-md-12">
            <button class="btn btn-success btn-block" onclick="window.location = '<?php echo base_url('manage/organizer/add_edit'); ?>'">Add Organizer</button>
        </div>
...
//                            display($list);
                            foreach ($list as $organizer):
                                ...
                                <tr>
                                    ...
                                    <td class="tdalign"><?php echo ($organizer['is_pvt_id'] == 1) ? 'Y' : 'N'; ?></td>
                                    ...
                                    <td class="table-action tdalign">
                                        ...
                                        <a title="Edit" href="<?php echo base_url('manage/organizer/add_edit/' . $organizer['organizer_id']); ?>"><i class="fa fa-pencil"></i></a>
                                        <?php if ($this->session->userdata('id') != $organizer['organizer_id']) { ?>
                                    ...
                                    <?php if ($this->session->userdata('is_superadmin') == 1) { ?>
                                        ...
                                        <td>
                                            <?php if ($organizer['event_id'] == '') { ?>
                                                <a class="btn btn-default btn-sm" href="javascript:void(0);" onClick="alert('Please create an Event for this Organizer before attempting to login.')">Login</a>
                                            <?php } else { ?>
                                                <a class="btn btn-default btn-sm" href="<?php echo base_url() ?>manage/login/adminLogin/O/<?php echo ($organizer["user_id"]); ?>" onClick="return confirm('Please confirm if you would like to login on behalf of this user?')">Login</a>
