...
<html lang="en">
 ...
 <!-- Preloader -->
       ...
       <!-- <script src="<?php echo base_url(); ?>public/admin/js/ckeditor/adapters/jquery.js"></script>-->
        ...
        <script src="<?php echo base_url(); ?>public/admin/js/flot.min.js"></script>
        <script src="<?php echo base_url(); ?>public/admin/js/flot.resize.min.js"></script>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <address>
                        ...
                        <strong>Feel free to Contact:</strong> 9898989898 <br>
