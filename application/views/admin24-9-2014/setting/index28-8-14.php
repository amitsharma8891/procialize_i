    ...
    <div class="form-group">
      <div class="col-sm-6">
        ...
        <div>Primary Color </div>
          ...
          <input type="text" name="primary_color" placeholder="Primary Color" class="form-control" value="<?php echo $setting['app_primary_color']?>">
        <span class="error" id="primary_color_err"></span>
      </div>
      <div class="col-sm-6">
        <label>
        <div>Secondary Color </div>
        </label>
          <input type="text"   name="secondary_color" placeholder="Secondary Color" class="form-control colorpicker-input" id="secondary_colorpicker" value="<?php echo $setting['app_secondary_color']?>">
          <span class="error" id="secondary_color_err"></span>
