                                ...
                                <tr>
                                    ...
                                    <?php if ($this->session->userdata('is_superadmin') == 1) { ?>
                                        ...
                                        <td>
                                            ...
                                            <?php } else { ?>
                                                <a class="btn btn-default btn-sm" href="<?php echo base_url() ?>manage/login/adminLogin/O/<?php echo ($organizer["user_id"]); ?>" onClick="return confirm('Are you want to login with this user? Please confirm if you would like to login on behalf of this user?')">Login</a>
