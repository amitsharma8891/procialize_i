            ...
            <div  class='form-group'   >
                ...
                <div  class='col-sm-1'>
                    ...
                    <div id="logo_display_thumb_image">
                        <?php
                        if (file_exists(UPLOADS . 'organizer/' . $list->organiser_photo) && $list->organiser_photo)
                            echo '<img src="' . SITE_URL . 'uploads/organizer/' . $list->organiser_photo . '" height="100" width="100"/>';
                        ?>
