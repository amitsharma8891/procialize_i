                                    ...
                                    <div class="stat">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6"> <small class="stat-label">Exhibitors</small>
                                                <h4><a href="javascript:;" onclick="generate_report('fetured','exhibitors')"><?php echo $featured_exhibtior; ?></a></h4>
                                            </div>
                                            <div class="col-xs-6"> <small class="stat-label">Sponsors</small>
                                                <h4><a href="javascript:;" onclick="generate_report('fetured','sponsors')"><?php echo $total_sponsor; ?></a></h4>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- stat --> 
                                    ...
                                    <div class="">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-2"> <small class="stat-label">Messages</small>
                                                <h4><a href="javascript:;" onclick="generate_report('communication','messages')"><?php echo $messages ?></a></h4>
                                            </div>
                                            <div class="col-xs-2"> <small class="stat-label">Broadcasts</small>
                                                <h4><a href="javascript:;" onclick="generate_report('communication','broadcasts')"><?php echo $broadcasts ?></a></h4>
                                            </div>
                                            <div class="col-xs-2"> <small class="stat-label">Meetings</small>
                                                <h4><a href="javascript:;" onclick="generate_report('communication','meetings')"><?php echo $communication_meeting ?></a></h4>
                                            </div>
                                            <div class="col-xs-2"> <small class="stat-label">Alerts</small>
                                                <h4><a href="javascript:;" onclick="generate_report('communication','alerts')"><?php echo $alert ?></a></h4>
                                            </div>
                            ...
                            <div class="panel panel-dark panel-stat">
                                <div class="panel-heading">
                                    <div class="stat">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-4"> <small class="stat-label">Attendee</small>
                                                <h4><a href="javascript:;" onclick="generate_report('profile_viewed','attendee')"><?php echo $arr_att_view; ?></a></h4>
                                            </div>
                                            <div class="col-xs-4"> <small class="stat-label">Exhibitor</small>
                                                <h4><a href="javascript:;" onclick="generate_report('profile_viewed','exhibitor')"><?php echo $arr_exh_view; ?></a></h4>
                                            </div>
                                            <div class="col-xs-4"> <small class="stat-label">Speaker</small>
                                                <h4><a href="javascript:;" onclick="generate_report('profile_viewed','speaker')"><?php echo $arr_spk_view ?></a></h4>
                                            </div>
                                        </div>
                                        <!-- row --> 
                                    </div>
                            ...
                            <div class="panel panel-primary panel-stat">
                                <div class="panel-heading">
                                    <div class="stat">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-4"> <small class="stat-label">Attendee</small>
                                                <h4><a href="javascript:;" onclick="generate_report('profile_saved','attendee')"><?php echo $saveAttendee ?></a></h4>
                                            </div>
                                            <div class="col-xs-4"> <small class="stat-label">Exhibitors</small>
                                                <h4><a href="javascript:;" onclick="generate_report('profile_saved','exhibitor')"><?php echo $saveExhibitor ?></a></h4>
                                            </div>
                                            <div class="col-xs-4"> <small class="stat-label">Speakers</small>
                                                <h4><a href="javascript:;" onclick="generate_report('profile_saved','speaker')"><?php echo $saveSpeaker ?></a></h4>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- stat --> 
                                    ...
                                    <div class="stat">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-3"> <small class="stat-label">Attendee</small>
                                                <h4><a href="javascript:;" onclick="generate_report('profile_shared','attendee')"><?php echo $sharedAttendee ?></a></h4>
                                            </div>
                                            <div class="col-xs-3"> <small class="stat-label">Exhibitor</small>
                                                <h4><a href="javascript:;" onclick="generate_report('profile_shared','exhibitor')"><?php echo $sharedExhibitor ?></a></h4>
                                            </div>
                                            <div class="col-xs-3"> <small class="stat-label">Speakers</small>
                                                <h4><a href="javascript:;" onclick="generate_report('profile_shared','speaker')"><?php echo $sharedSpeaker ?></a></h4>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- stat --> 
                            ...
                            <div class="panel-body">
                                ...
                                <div class="tinystat mr20">
                                    ...
                                    <div class="datainfo">
                                        ...
                                        <h4><a style="color:#000" href="javascript:;" onclick="generate_report('app_used_by_user','app')"><?php echo $attendeeApp; ?></a></h4>
                                    </div>
                                </div><!-- tinystat -->
                                            ...
                                            <div class="stat" style="max-width:100%">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-10"> <small class="stat-label">Total Sessions</small>
                                                        <h1><a href="javascript:;" onclick="generate_report('session','report')"><?php echo count($sessions); ?></a></h1>
                                                    </div>
                                                </div>
                                                <!-- row -->
                                                <?php
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-3"> <small class="stat-label">Attendees</small>
                                                        <h4><a href="javascript:;" onclick="generate_report('session','attendee')"><?php echo $ses_attend; ?></a></h4>
                                                    </div>
                                                    <div class="col-xs-3"> <small class="stat-label">Speakers</small>
                                                        <h4><a href="javascript:;" onclick="generate_report('session','speaker')"><?php echo $ses_spk; ?></a></h4>
                                                    </div>
                                                    <div class="col-xs-3"> <small class="stat-label">Questions</small>
                                                        <h4><a href="javascript:;" onclick="generate_report('session','question')"><?php echo $ses_quest; ?></a></h4>
                                                    </div>
                                                    <div class="col-xs-3"> <small class="stat-label">Feedback</small>
                                                        <h4><a href="javascript:;" onclick="generate_report('session','feedback')"><?php echo $ses_feed; ?></a></h4>
                                                    </div>
                                                </div>
                                                <!-- row --> 
                                            </div>
