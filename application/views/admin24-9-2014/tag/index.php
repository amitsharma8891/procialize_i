...
<div class="contentpanel"><!-- Content Panel -->
    ...
    <div class="row mb20"><!-- Exhibitor Row -->
        ...
        <div class="col-sm-12 col-md-12">
            <button class="btn btn-success btn-block" onclick="window.location = '<?php echo base_url('manage/tag/add/'); ?>'">Add Tag</button>
        </div>
                ...
                <li>
                    <div class="ckbox ckbox-default">
                        <select type="select" id="sort-list" class="form-control">
                            <option value="<?php echo base_url('manage/tag/0'); ?>">A - Z</option>
                            <option value="<?php echo base_url('manage/tag/1'); ?>">Z - A</option>
                ...
                <div class="table-responsive">
                    <table class="table mb30">
						...
						<tbody>
                            ...
                            foreach ($list as $tag) { ?>
                                <tr>
                                    <td class="text-center"><input type="checkbox" name="delete[]" class="checkboxes-custom" value="<?php echo $tag["id"]; ?>"></td>
                                    
                                    
                                    <td><?php echo $tag["tag_name"] ?> </td>
                                    
                                    <td class="table-action">
                                        <a title="Edit" href="<?php echo base_url(); ?>manage/tag/edit/<?php echo $tag["id"]; ?>"><i class="fa fa-pencil"></i></a>
                                        <a title="Delete" href="#" data="<?php echo $tag["id"]; ?>" class="delete-row"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
...
<script>
                delete_url = '<?php echo base_url('manage/tag/delete/json'); ?>'
</script>