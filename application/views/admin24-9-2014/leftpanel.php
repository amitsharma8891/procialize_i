<div class="logopanel">
    <img src="<?php echo base_url() ?>public/admin/images/pl.png" />
</div><!-- logopanel -->
...
<div class="leftpanelinner mt10">    
    ...
    <div class="visible-xs hidden-sm hidden-md hidden-lg">   
        <div class="media userlogged">
            <img alt="" src="<?php echo SITE_URL?>public/admin/images/photos/loggeduser.png" class="media-object">
...
//        $superadmin = false;
        ...
        ?>
        <?php
        $arrSkipArrow = array('exhibitor profile', 'Profile', 'Announcement', 'Survey', 'Dashboard', 'Survey', 'Industry', 'Functionality', 'Email Template');
        if (!$superadmin) {
            $i = 0;
...
//                                $event_id = $event["event_id"];
    ...
    ?>
            ...
            $arrSkipArrow = array('Exhibitor Profile', 'Announcement', 'Survey', 'Dashboard', 'Survey', 'Industry', 'Functionality', 'Email Template');
