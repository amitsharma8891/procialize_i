...
//        $to = "anupam.bhatnagar@infiniteit.biz";
    ...
    function common_set_meeting($type, $user_data, $event_id, $subject_id, $subject_type) {
        ...
        $to = $get_target_attendee->email;
        //MAIL TEMLATE
        $keywords = array('{app_name}', '{event_name}', '{meeting_date}', '{meeting_time}', '{subject_first_name}', '{object_first_name}', '{msg_content}', '{app_contact_email}', '{site_url}', '{IMAGE_PATH}', '{logo_image}');
        $replace_with = array(
            $email_template['setting']['app_name'],
            $organizer_data->event_name,
    ...
    function common_do_rsvp($user_data, $event_id, $session_id) {
        ...
        if (!$check_rsvp) {
            ...
            $keywords = array('{app_name}', '{session_name}', '{org_name}', '{object_first_name}', '{event_name}', '{first_name}', '{email}', '{app_contact_email}', '{site_url}', '{IMAGE_PATH}', '{logo_image}');
            $replace_with = array(
                $email_template['setting']['app_name'],
    ...
    function common_save_share($user_data, $data) {
        ...
        $keywords = array('{app_name}', '{event_name}', '{first_name}', '{save_shared}', '{subject_first_name}', '{object_first_name}', '{app_contact_email}', '{site_url}', '{IMAGE_PATH}', '{logo_image}');
        $replace_with = array(
            $email_template['setting']['app_name'],
            $organizer_data->event_name,
            $user_data->first_name,
    ...
    function common_event_registration($user_data, $event_id) {
        ...
        if ($check_attendee) {
            ...
            $keywords = array('{app_name}', '{event_name}', '{org_name}', '{first_name}', '{email}', '{app_contact_email}', '{site_url}', '{IMAGE_PATH}', '{logo_image}');
            $replace_with = array(
                $email_template['setting']['app_name'],
                $organizer_data->event_name,
                $organizer_data->organizer_name,
