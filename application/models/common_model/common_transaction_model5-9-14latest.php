...
//        display($get_target_attendee);
        ...
        $keywords = array('{app_name}', '{event_name}', '{subject_first_name}', '{first_name}', '{object_first_name}', '{msg_content}', '{app_contact_email}','{site_url}', '{IMAGE_PATH}', '{logo_image}','{apple_app_store}','{google_play_store}');,'{logo_image}');
        $replace_with = array(
            ...
            SITE_URL,
            CLIENT_IMAGES,
            $email_template['setting']['app_logo_small'],
        );
    ...
    function common_set_meeting($type, $user_data, $event_id, $subject_id, $subject_type) {
        ...
        $keywords = array('{app_name}', '{event_name}', '{meeting_date}', '{meeting_time}', '{subject_first_name}', '{object_first_name}', '{msg_content}', '{app_contact_email}','{site_url}', '{IMAGE_PATH}', '{logo_image}','{apple_app_store}','{google_play_store}'););
        $replace_with = array(
            $email_template['setting']['app_name'],
            $organizer_data->event_name,
    ...
    function common_do_rsvp($user_data, $event_id, $session_id) {
        ...
        if (!$check_rsvp) {
            ...
            $keywords = array('{app_name}', '{session_name}', '{org_name}', '{first_name}', '{email}', '{app_contact_email}','{site_url}', '{IMAGE_PATH}', '{logo_image}','{apple_app_store}','{google_play_store}'););
            $replace_with = array(
                $email_template['setting']['app_name'],
