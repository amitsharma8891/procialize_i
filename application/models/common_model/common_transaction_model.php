...
//        $to = "anupam.bhatnagar@infiniteit.biz";
    ...
    function common_event_registration($user_data, $event_id) {
        ...
        if ($check_attendee) {
            ...
            $keywords = array('{app_name}', '{event_name}', '{org_name}', '{first_name}', '{email}', '{object_first_name}', '{app_contact_email}', '{site_url}', '{IMAGE_PATH}', '{logo_image}', '{apple_app_store}', '{google_play_store}');
            $replace_with = array(
                $email_template['setting']['app_name'],
                $organizer_data->event_name,
                $organizer_data->organizer_name,
