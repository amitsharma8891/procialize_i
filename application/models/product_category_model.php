...
class product_category_model extends CI_Model {
    ...
    public $order_by = 'ASC';
    public $order_name = 'product_category.id';
            ...
            'name' => array("name" => "name",
                ...
                "decorators" => array(
                    ...
                    array(
                        ...
                        "content" => '<div>Product Category Name</div>',
...
//            ),
        ...
        if (isset($id)) {
            $arrData['action'] = base_url() . 'manage/product_category/edit/' . $id;
        } else {
            $arrData['action'] = base_url() . 'manage/product_category/add';
        }
...
//         echo $this->db->last_query();
    ...
    function check_unique($data, $id = NULL) {
        ...
        $this->db->where('product_category.name', $data);
        if ($id) {
            $this->db->where('product_category.id', $id);
        }
        $result_set = $this->db->get('product_category');
