...
class Industry_model extends CI_Model {
    ...
    function generate_fields($id = NULL) {
        ...
        if (isset($id)) {
            $arrData['action'] = base_url() . 'manage/industry/edit/' . $id;
        } else {
            $arrData['action'] = base_url() . 'manage/industry/add';
        }
    ...
    function save($data, $id = NULL) {
        ...
        if (is_null($id)) {
            ...
            $this->db->where('id', $id);
            $result = $this->db->update('industry', $data);
        }
        if ($result) {
            return $id;
        } else {
    ...
    function get($id = NULL, $row = FALSE) {
        ...
        if ($row) {
            $result = $this->db->get('industry')->row();
    ...
    function check_unique($data, $id= NULL) {
        ...
        $result_set = $this->db->get('industry');
