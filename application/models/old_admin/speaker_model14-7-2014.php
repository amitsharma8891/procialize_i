    ...
    function sendPasscode($data = array()) {
        ...
        foreach ($data as $id) {
            ...
            if (is_array($arrEmail)) {
                ...
                $arrInsert['content'] = "Welcome to {$objAttend->event_name}! View profiles of other Attendees, Setup meetings, Send messages and explore lot more by getting into the Event. Your Passcode for the Event is {$objAttend->passcode}. Apply Code!";
                $arrInsert['status'] = 1;
