       ...
       //  echo '<pre>';print_r($arrResult);exit;
        ...
        $arrData['fields'] = array(
            ...
            'tag' => array("name" => "tag_name",
                ...
                "validate" => '',
                "error" => 'Tag',
                "value" => set_value('tag_name', (isset($arrResult->tag) ? $arrResult->tag : (isset($postarray['tag_name']) ? $postarray['tag_name'] : ''))),
                "decorators" => array(
                    array(
                        "tag" => "div",
                        "close" => "true",
          ...
          'description' => array("name" => "description",
            ...
            'event_start' => array("name" => "event_start",
                ...
                "value" => set_value('event_start', (isset($arrResult->event_start) ? date('d-F-Y', strtotime($arrResult->event_start)) : (isset($postarray['event_start']) ? $postarray['event_start'] : ''))),
                "decorators" => array(
                    array(
                        "tag" => "div",
                        "close" => "false",
            ...
            'event_end' => array("name" => "event_end",
                ...
                "validate" => 'required',
                "error" => 'Event End',
                "value" => set_value('event_end', (isset($arrResult->event_end) ? date('d-F-Y', strtotime($arrResult->event_end)) : (isset($postarray['event_end']) ? $postarray['event_end'] : ''))),
                "decorators" => array(
                    array(
                        "tag" => "div",
                        "close" => "true",
            ...
            'facebook_link' => array("name" => "facebook",
                ...
                "decorators" => array(
					...
					array(
                        ...
                        "close" => "false",
                        "class" => "col-sm-1 control-label form-label-placeholder",
                        "content" => '<div>Event Facebook Link</div>',
                        "position" => "prependElement",
                    ),
                ),
            ),
            'twitter_link' => array("name" => "twitter",
                ...
                "decorators" => array(
					...
					array(
                        ...
                        "close" => "false",
                        "class" => "col-sm-1 control-label form-label-placeholder",
                        "content" => '<div>Event Twitter Handle</div>',
                        "position" => "prependElement",
                    ),
                ),
            ),
