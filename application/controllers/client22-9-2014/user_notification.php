...
//        /display($data);exit;
    ...
    function saveToggle() {
        ...
        if (is_numeric($data['subject_id']) && $data['toggle_flag'] && $data['attendee_id'] && $data['type']) {
            ...
            $keywords = array('{app_name}', '{event_name}', '{first_name}', '{subject_first_name}', '{save_shared}', '{object_first_name}', '{app_contact_email}', '{site_url}', '{IMAGE_PATH}', '{logo_image}');
            $replace_with = array(
                ...
                $save_social,
                $this->session->userdata('client_first_name') . ',' . $this->session->userdata('client_user_company'),
        ...
        if (is_numeric($data['subject_id']) && $data['toggle_flag'] && $data['attendee_id'] && $data['type']) {
            ...
            if ($data['to']) {
                ...
                if ($to_array) {
                    ...
                    $keywords = array('{app_name}', '{mail_content}', '{app_contact_email}', '{site_url}', '{IMAGE_PATH}', '{logo_image}');
