$(function() {
    //alert(SITE_URL);    
       var site_url                                                               = $("#hidden_site_url").val();
        ...
        url                                                                     : SITE_URL+'admin_upload.php/?image_type=app_logo',//site_url+'admin/breed/process_image',
	...
	uploader.bind('FileUploaded', function(up, file,info) {
		...
		$('#logo_display_thumb_image').html('<img src="'+SITE_URL+'uploads/app_logo/'+filename+'" height="76" width="76"><input type="hidden" name="app_logo_image" id="app_logo_image" value="'+filename+'">');
