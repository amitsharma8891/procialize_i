$(function() {
    //alert(SITE_URL);    
       var site_url                                                               = $("#hidden_site_url").val();
        ...
        url                                                                     : SITE_URL+'admin_upload.php/?image_type=app_background',//site_url+'admin/breed/process_image',
	...
	uploader.bind('Error', function(up, err) {
		$('#background_filelist').append("<div>Error: " + err.code +
			", Message: " + err.message +
	...
	uploader.bind('FileUploaded', function(up, file,info) {
		...
		$('#background_display_thumb_image').html('<img src="'+SITE_URL+'uploads/app_background/'+filename+'" height="100" width="100"><input type="hidden" name="app_background_image" id="app_background_image" value="'+filename+'">');
