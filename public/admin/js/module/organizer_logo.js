$(function() {
    //alert(SITE_URL);    
       var site_url                                                               = $("#hidden_site_url").val();
        ...
        browse_button                                                           : 'logo_pickfiles',
        container                                                               : 'logo_container',
        max_file_size                                                           : '10mb',
        multi_selection                                                         : false,    
        url                                                                     : SITE_URL+'admin_upload.php/?image_type=organizer/logo/',//site_url+'admin/breed/process_image',
	...
	uploader.bind('Error', function(up, err) {
		$('#logo_filelist').append("<div>Error: " + err.code +
			", Message: " + err.message +
	...
	uploader.bind('FileUploaded', function(up, file,info) {
		...
		$('#logo_display_thumb_image').html('<img src="'+SITE_URL+'uploads/organizer/logo/'+filename+'" height="76" width="76"><input type="hidden" name="app_logo_image" id="app_logo_image" value="'+filename+'">');
