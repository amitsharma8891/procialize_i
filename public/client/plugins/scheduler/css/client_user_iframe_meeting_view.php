...
//    /alert('test'+start+end+'target'+$("#target_id").val());
  ...
  <div id="calendar">
      <div class="dateSelectrDropd" style="padding:15px 0px 15px 15px; background:#E4E7EA; width:100%;">
                <label style="float:left; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#333; margin-right:10px; margin-top:5px;">Select Date:</label>
                <select style="float:left;font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#333; width:130px; padding:5px 5px; border:none;">
